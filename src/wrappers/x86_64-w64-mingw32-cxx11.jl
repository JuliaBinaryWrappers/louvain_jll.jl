# Autogenerated wrapper script for louvain_jll for x86_64-w64-mingw32-cxx11
...
const convertlouvain_splitpath = ["bin", "convert.exe"]
...
const hierarchy_splitpath = ["bin", "hierarchy.exe"]
...
const louvain_splitpath = ["bin", "louvain.exe"]
